"""plot_profile documentation build configuration file.
...
version = plot_profile.__version__
# The full version, including alpha/beta/rc tags.
release = plot_profile.__version__
...
htmlhelp_basename = "plot_profiledoc"
