...
VENV_NAME ?= plot_profile#OPT Name of conda virtual environment (overridden by VENV_DIR)

# Default values used below (caution: keep values in sync with above)
DEFAULT_VENV_NAME = plot_profile#
...
# 	\rm -f docs/plot_profile.rst
# 	\rm -f docs/modules.rst
# 	${PREFIX}sphinx-apidoc -o docs/ src/plot_profile
# 	$(MAKE) -C docs clean
# 	$(MAKE) -C docs html
